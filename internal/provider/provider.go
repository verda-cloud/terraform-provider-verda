...
func (p *VerdaProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewClusterResource,
		NewInstanceResource,
		NewInstanceActionResource,
		NewSSHKeyResource,
		NewSSHKeyBulkDeleteResource,
		NewStartupScriptResource,
		NewStartupScriptBulkDeleteResource,
		NewVolumeResource,
		NewVolumeActionResource,
		NewContainerResource,
		NewContainerScalingResource,
		NewContainerEnvironmentVariablesResource,
		NewContainerActionResource,
		NewContainerRegistryCredentialsResource,
		NewServerlessJobResource,
		NewJobActionResource,
		NewSecretResource,
...
func (p *VerdaProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewContainerDeploymentEnvironmentVariablesDataSource,
